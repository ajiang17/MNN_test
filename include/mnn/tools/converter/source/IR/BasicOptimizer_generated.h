...
struct BackendConfig FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool mutate_memroy(int32_t _memroy) {
    return SetField<int32_t>(VT_MEMROY, _memroy, 0);
  }
  MNN::ForwardType type() const {
    return static_cast<MNN::ForwardType>(GetField<int8_t>(VT_TYPE, 0));
  }
  bool mutate_type(MNN::ForwardType _type) {
  ...
  bool mutate_power(int32_t _power) {
    return SetField<int32_t>(VT_POWER, _power, 0);
  }
  int32_t numberThread() const {
    return GetField<int32_t>(VT_NUMBERTHREAD, 1);
  }
  bool mutate_numberThread(int32_t _numberThread) {
    return SetField<int32_t>(VT_NUMBERTHREAD, _numberThread, 1);
  }
...
struct MergeT : public flatbuffers::NativeTable {
  ...
  std::vector<std::unique_ptr<MNN::BlobT>> tensors;
...
struct Merge FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::Vector<flatbuffers::Offset<MNN::Blob>> *tensors() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<MNN::Blob>> *>(VT_TENSORS);
  }
  flatbuffers::Vector<flatbuffers::Offset<MNN::Blob>> *mutable_tensors() {
    return GetPointer<flatbuffers::Vector<flatbuffers::Offset<MNN::Blob>> *>(VT_TENSORS);
  }
  const BackendConfig *backend() const {
    return GetPointer<const BackendConfig *>(VT_BACKEND);
  }
  BackendConfig *mutable_backend() {
    return GetPointer<BackendConfig *>(VT_BACKEND);
  }
  ...
  flatbuffers::Vector<flatbuffers::Offset<MNN::Op>> *mutable_oplists() {
    return GetPointer<flatbuffers::Vector<flatbuffers::Offset<MNN::Op>> *>(VT_OPLISTS);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct MergeBuilder {
  ...
  void add_tensors(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<MNN::Blob>>> tensors) {
    fbb_.AddOffset(Merge::VT_TENSORS, tensors);
  }
...
inline flatbuffers::Offset<Merge> CreateMerge(
    ...
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<MNN::Blob>>> tensors = 0,
...
inline flatbuffers::Offset<Merge> CreateMergeDirect(
    ...
    const std::vector<flatbuffers::Offset<MNN::Blob>> *tensors = nullptr,
    flatbuffers::Offset<BackendConfig> backend = 0,
  ...
  auto tensors__ = tensors ? _fbb.CreateVector<flatbuffers::Offset<MNN::Blob>>(*tensors) : 0;
...
inline void Merge::UnPackTo(MergeT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = tensors(); if (_e) { _o->tensors.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->tensors[_i] = std::unique_ptr<MNN::BlobT>(_e->Get(_i)->UnPack(_resolver)); } } };
...
inline flatbuffers::Offset<Merge> CreateMerge(flatbuffers::FlatBufferBuilder &_fbb, const MergeT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  ...
  auto _tensors = _o->tensors.size() ? _fbb.CreateVector<flatbuffers::Offset<MNN::Blob>> (_o->tensors.size(), [](size_t i, _VectorArgs *__va) { return CreateBlob(*__va->__fbb, __va->__o->tensors[i].get(), __va->__rehasher); }, &_va ) : 0;
