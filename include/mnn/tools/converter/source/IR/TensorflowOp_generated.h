...
enum BinaryOpOperation {
  ...
  BinaryOpOperation_MAX = BinaryOpOperation_LESS_EQUAL
};

inline const BinaryOpOperation (&EnumValuesBinaryOpOperation())[17] {
...
inline const char *EnumNameBinaryOpOperation(BinaryOpOperation e) {
  if (e < BinaryOpOperation_ADD || e > BinaryOpOperation_LESS_EQUAL) return "";
...
struct ReverseSequenceParam FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool mutate_batchDim(int32_t _batchDim) {
    return SetField<int32_t>(VT_BATCHDIM, _batchDim, 0);
  }
  int32_t seqDim() const {
    return GetField<int32_t>(VT_SEQDIM, 0);
  }
  bool mutate_seqDim(int32_t _seqDim) {
    return SetField<int32_t>(VT_SEQDIM, _seqDim, 0);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
