...
inline const OpType (&EnumValuesOpType())[133] {
...
enum OpParameter {
  ...
  OpParameter_MAX = OpParameter_ELU
};

inline const OpParameter (&EnumValuesOpParameter())[82] {
...
inline const char *EnumNameOpParameter(OpParameter e) {
  if (e < OpParameter_NONE || e > OpParameter_ELU) return "";
  const size_t index = static_cast<int>(e);
...
struct Extra FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  flatbuffers::String *mutable_engine() {
    return GetPointer<flatbuffers::String *>(VT_ENGINE);
  }
  const flatbuffers::Vector<int8_t> *info() const {
    return GetPointer<const flatbuffers::Vector<int8_t> *>(VT_INFO);
  }
  flatbuffers::Vector<int8_t> *mutable_info() {
    return GetPointer<flatbuffers::Vector<int8_t> *>(VT_INFO);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyOffset(verifier, VT_TYPE) &&
...
struct Op FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  bool mutate_defaultDimentionFormat(MNN_DATA_FORMAT _defaultDimentionFormat) {
    return SetField<int8_t>(VT_DEFAULTDIMENTIONFORMAT, static_cast<int8_t>(_defaultDimentionFormat), 1);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
inline OpParameterUnion::OpParameterUnion(const OpParameterUnion &u) FLATBUFFERS_NOEXCEPT : type(u.type), value(nullptr) {
  switch (type) {
    ...
    case OpParameter_Extra: {
      value = new ExtraT(*reinterpret_cast<ExtraT *>(u.value));
      break;
    }
    case OpParameter_Pool3D: {
...
inline const flatbuffers::TypeTable *OpTypeTypeTable() {
  ...
  static const flatbuffers::TypeTable tt = {
    flatbuffers::ST_ENUM, 133, type_codes, type_refs, values, names
  };
  return &tt;
}
...
inline const flatbuffers::TypeTable *OpParameterTypeTable() {
  ...
  static const flatbuffers::TypeTable tt = {
    flatbuffers::ST_UNION, 82, type_codes, type_refs, nullptr, names
  };
  return &tt;
}
